...
import 'package:house_rental/Screen/House-Owner/Dashboard/Register_renter/uploaded_constitution_document_page.dart';

class constitution_document extends StatefulWidget {
  const constitution_document({Key? key}) : super(key: key);

  @override
  State<constitution_document> createState() => _constitution_documentState();
}

class _constitution_documentState extends State<constitution_document> {
                    ...
                    child: TextButton(
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  uploaded_constiturion_document_page()));
                        },
                        child: Text(
                          "Upload",
                          style: TextStyle(color: Colors.white, fontSize: 17),
