...
class payments_per_individual extends StatefulWidget {
  String renter_id;
   payments_per_individual({Key? key, required  this.renter_id }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Contract details",style: TextStyle(color: Colors.white,fontSize: 17),),
      ),
                                              ...
                                              child: TextButton(
                                                  onPressed: () {
                                                    Navigator.of(context).push(
                                                        MaterialPageRoute(
                                                            builder: (context) =>
                                                                view_contract(renter_id: widget.renter_id, start_date: startDate,)));
                                                  },
                                                  child: Text(
                                                    "view contract",
